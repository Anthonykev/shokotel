...
<div class="col-md-6">
    ...
    <button class="w-100 btn btn-light btn-lg btn-hover-dark" type="submit">Buchen</button>
                        ...
                        <!-- Neue Checkboxen für Frühstück und Parkplatz -->
...
<?php if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($gesamtBetrag)) { ?>
    <div class="alert alert-success" role="alert">
        Sie haben diese Anzahl an Personen ausgewählt: <?php echo $anzahlPersonen; ?> <br>
        Daher ist der Preis für ihre Zimmerauswahl: <?php echo $zimmerPreis; ?> Euro <br>
        Der Betrag Ihrer Buchung /Tag beläuft sich auf: <?php echo $gesamtBetrag; ?> Euro. Vielen Dank für Ihre Buchung!
    </div>
<?php } ?>
                        ...
                        <button class="w-100 btn btn-light btn-lg" type="submit">Buchen</button>
                    </form>
                </div>
